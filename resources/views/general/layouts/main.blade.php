...
<head>
    ...
    <link rel='stylesheet' href="{{asset('/kingster/plugins/goodlayers-core/plugins/combine/style.css')}}" type='text/css' media='all' />
    <link rel='stylesheet' href="{{asset('/kingster/plugins/goodlayers-core/include/css/page-builder.css')}}" type='text/css' media='all' />
    <link rel='stylesheet' href="{{asset('/kingster/plugins/revslider/public/assets/css/settings.css')}}" type='text/css' media='all' />
    <link rel='stylesheet' href="{{asset('/kingster/css/style-core.css')}}" type='text/css' media='all' />
    <link rel='stylesheet' href="{{asset('/kingster/css/kingster-style-custom.css')}}" type='text/css' media='all' />
...
<body class="home page-template-default page page-id-2039 gdlr-core-body woocommerce-no-js tribe-no-js kingster-body kingster-body-front kingster-full  kingster-with-sticky-navigation  kingster-blockquote-style-1 gdlr-core-link-to-lightbox">
            ...
            <div class="kingster-mobile-header-container kingster-container clearfix">
                <div class="kingster-logo  kingster-item-pdlr">
                    <div class="kingster-logo-inner">
                        <a class="" href="index.html"><img src="{{asset('/kingster/images/logo.png')}}" alt="" /></a>
                    </div>
                </div>
                                        ...
                                        <div class="sf-mega sf-mega-full megaimg">
                                            <ul class="sub-menu">
                                                ...
                                                <li class="menu-item" data-size="15">
                                                    <div class="kingster-mega-menu-section-content"><img src="{{asset('/kingster/upload/mega-menu-logo.png')}}" style="margin-bottom: 13px;" alt="" /> <span style="font-size: 14px; font-weight: 500;">Academic offerings include 95 majors, 86 minors, and more than 100 in-major specializations</span></div>
                                                </li>
                                            </ul>
                                        </div>
                                    </li>
                        ...
                        <div class="kingster-footer-column kingster-item-pdlr kingster-column-15">
                            <div id="text-2" class="widget widget_text kingster-widget">
                                <div class="textwidget">
                                    <p><img src="{{asset('/kingster/upload/footer-logo.png')}}" alt="" />
	...
	<script type='text/javascript' src="{{asset('/kingster/js/jquery/jquery.js')}}"></script>
    <script type='text/javascript' src="{{asset('/kingster/js/jquery/jquery-migrate.min.js')}}"></script>
    <script type='text/javascript' src="{{asset('/kingster/plugins/revslider/public/assets/js/jquery.themepunch.tools.min.js')}}"></script>
    <script type='text/javascript' src="{{asset('/kingster/plugins/revslider/public/assets/js/jquery.themepunch.revolution.min.js')}}"></script>
    <script type="text/javascript" src="{{asset('/kingster/plugins/revslider/public/assets/js/extensions/revolution.extension.slideanims.min.js')}}"></script>
    <script type="text/javascript" src="{{asset('/kingster/plugins/revslider/public/assets/js/extensions/revolution.extension.layeranimation.min.js')}}"></script>
    <script type="text/javascript" src="{{asset('/kingster/plugins/revslider/public/assets/js/extensions/revolution.extension.kenburn.min.js')}}"></script>
    <script type="text/javascript" src="{{asset('/kingster/plugins/revslider/public/assets/js/extensions/revolution.extension.navigation.min.js')}}"></script>
    <script type="text/javascript" src="{{asset('/kingster/plugins/revslider/public/assets/js/extensions/revolution.extension.parallax.min.js')}}"></script>  
    <script type="text/javascript" src="{{asset('/kingster/plugins/revslider/public/assets/js/extensions/revolution.extension.actions.min.js')}}"></script> 
    <script type="text/javascript" src="{{asset('/kingster/plugins/revslider/public/assets/js/extensions/revolution.extension.video.min.js')}}"></script>
    ...
    <script type='text/javascript' src="{{asset('/kingster/plugins/goodlayers-core/plugins/combine/script.js')}}"></script>
    <script type='text/javascript'>
        var gdlr_core_pbf = {
            "admin": "",
            "video": {
    ...
    <script type='text/javascript' src="{{asset('/kingster/plugins/goodlayers-core/include/js/page-builder.js')}}"></script>



    <script type='text/javascript' src="{{asset('/kingster/js/jquery/ui/effect.min.js')}}"></script>
    <script type='text/javascript'>
        var kingster_script_core = {
            "home_url": "https:\/\/demo.goodlayers.com\/kingster\/"
        };
    </script>
    <script type='text/javascript' src="{{asset('/kingster/js/plugins.min.js')}}"></script>
    <script>
        /*<![CDATA[*/
